...
/*Left*/	case 'D': backward_chars(view); break;
	...
	/*Home*/case 'H': locus_set(view, CURSOR, 0); break;
	/*End*/	case 'F': locus_set(view, CURSOR, view->bytes); break;
	/*F1 - terminal emulator help */ case 'P': return funckey(view, 1);
	/*F2*/	case 'Q': return funckey(view, 2);
	/*F3*/	case 'R': return funckey(view, 3);
	/*F4*/	case 'S': return funckey(view, 4);
		default: return 0;
		}
		break;

	/* Others: treat as if they had been Control-(key) */
